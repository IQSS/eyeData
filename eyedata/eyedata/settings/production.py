...
STATIC_ROOT = '/var/www/eyedata/static'
MEDIA_ROOT = '/var/www/eyedata/media'
...
#ALLOWED_HOSTS = ['localhost', '*.pagekite.me', 'eyeData', 'www.eyeData' ]
ALLOWED_HOSTS = ['eyedata.datascience.iq.harvard.edu',  ]
